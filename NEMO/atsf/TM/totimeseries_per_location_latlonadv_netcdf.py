...
#%%
print dirRead + 'global_sp%d_dd%d/'%(int(sp),int(dd))  + 'concatenated_sp%d_dd%d_res%d.nc'%(int(sp),int(dd),res)
pfile = Dataset(dirRead + 'global_sp%d_dd%d/'%(int(sp),int(dd))  + 'concatenated_sp%d_dd%d_res%d.nc'%(int(sp),int(dd),res) )
pfilefix = Dataset(dirRead + 'surface/' + 'concatenatedsurface_dd%d_res%d.nc'%(int(dd),res) )
